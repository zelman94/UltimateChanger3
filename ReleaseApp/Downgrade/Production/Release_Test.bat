...
REM Program HI simulator device using ToolProgramController.exe
REM -------------------------------------------
Controller\ToolProgramController.exe -a ..\Firmware\Application.bin
IF %ERRORLEVEL% NEQ 0 GOTO fail
timeout /t 5 /nobreak
Controller\ToolProgramController.exe -a ..\Firmware\Service.bin
IF %ERRORLEVEL% NEQ 0 GOTO fail
